...
<div id="hd_login_msg">최고관리자 최고관리자님 로그인 중 <a href="<?php echo G5_BBS_URL;?>/logout.php">로그아웃</a></div>
...
<header id="hd">
    ...
    <div id="hd_top">
        ...
        <div id="logo"><a href="<?php echo G5_ERP_URL;?>"><img src="<?php echo G5_ERP_URL;?>/img/logo.png" alt="마케팅콜센터 관리자" title=""></a></div>
            ...
            <ul class="gnb_ul">
                <li class="gnb_li on">
                    ...
                    <div class="gnb_oparea_wr">
                        <div id="scrollbar" class="gnb_oparea mCustomScrollbar"  data-mcs-theme="minimal-dark">
                            <h3>DB관리</h3>
                            <ul>
                                <li data-menu="100100"><a href="http://192.168.0.112:8001/adm/config_form.php" class="gnb_2da on">DB목록</a></li>
                                <li data-menu="100200"><a href="http://192.168.0.112:8001/adm/auth_list.php" class="gnb_2da">상담원배정</a></li>
                            ...
                            <h3>업무관리</h3>
                            <ul>
                                <li data-menu="100100"><a href="http://192.168.0.112:8001/adm/config_form.php" class="gnb_2da">공지사항</a></li>
                                <li data-menu="100200"><a href="http://192.168.0.112:8001/adm/auth_list.php" class="gnb_2da">관리권한설정</a></li>
                                <li data-menu="100280"><a href="http://192.168.0.112:8001/adm/theme.php" class="gnb_2da gnb_grp_style gnb_grp_div">테마설정</a></li>
                                <li data-menu="100290"><a href="http://192.168.0.112:8001/adm/menu_list.php" class="gnb_2da gnb_grp_style ">메뉴설정</a></li>
                                <li data-menu="100300"><a href="http://192.168.0.112:8001/adm/sendmail_test.php" class="gnb_2da  gnb_grp_div">메일 테스트</a></li>
                            </ul>
